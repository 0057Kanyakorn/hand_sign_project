...
def gen_frames():
    ...
    while True:
        ...
        if res.multi_hand_landmarks:
            ...
            cv2.putText(frame, f"{pred_label} ({conf:.2f})", (10,80), cv2.FONT_HERSHEY_SIMPLEX, 2.0, (0,255,0),3)
        else:
            no_hand_count += 1
            stable_count = 0
            last_pred = None
        ...
        cv2.putText(frame, display_text, (10,h-40), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (255,255,255),3)
